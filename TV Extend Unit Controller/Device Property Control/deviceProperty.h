...
struct
{
	...
	// NOTE:	Since the strings and the transmission process is using the ASCII Codepage, Multibyte character like �,�,� or � are not supported.
	...
	//			'�' = '^' (0x5e);; '�' = '[' (0x5b);; � = ']' (0x5d);; '�' = '{' (0x7b);; '�' = '}' (0x7d);; '�' = '|' (0x7c);; '�' = '~' (0x7e)
	//
